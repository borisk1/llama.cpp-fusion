...
extern "C" {
    ...
    LLAMA_API bool llama_model_set_thread_copy_groups(
            struct llama_model * model,
            int n_groups,
            const int * numa_node_ids);
    ...
    LLAMA_API void llama_memory_set_thread_copy_groups(llama_memory_t mem, int n_groups, const int * numa_node_ids);
    LLAMA_API void llama_memory_broadcast_thread_copy_kv(llama_memory_t mem, uint32_t cell_start, uint32_t n_cells);
