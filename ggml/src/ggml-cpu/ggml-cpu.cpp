...
static void * ggml_backend_cpu_get_proc_address(ggml_backend_reg_t reg, const char * name) {
    ...
    if (strcmp(name, "ggml_threadpool_set_thread_copy_groups") == 0) {
        return (void *)ggml_threadpool_set_thread_copy_groups;
    }
    if (strcmp(name, "ggml_threadpool_get_group_id") == 0) {
        return (void *)ggml_threadpool_get_group_id;
    }
    if (strcmp(name, "ggml_threadpool_get_n_groups") == 0) {
        return (void *)ggml_threadpool_get_n_groups;
    }
    if (strcmp(name, "ggml_threadpool_set_n_groups") == 0) {
        return (void *)ggml_threadpool_set_n_groups;
    }
    if (strcmp(name, "ggml_threadpool_set_hierarchical_barrier") == 0) {
        return (void *)ggml_threadpool_set_hierarchical_barrier;
    }
