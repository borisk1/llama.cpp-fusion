...
> **Note on hardware:** All benchmarks were performed on a system with **4× RTX 3090** connected via **OCuLink** (PCIe 3.0 x4 per link, aggregated) and a **dual Xeon Platinum 8160 (Skylake)** — 2× 24 cores, NUMA nodes 0-1, **768 GB DDR4**. OCuLink bandwidth is lower than direct PCIe 3.0 x16 slots — expect higher throughput on systems with native PCIe 4.0. The MoE Cache and CPU-MoE hybrid modes are especially beneficial on OCuLink setups, as they minimize PCIe transfers.
