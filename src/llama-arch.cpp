...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_DEEPSEEK4_DFLASH_DRAFT, "deepseek4-dflash-draft" },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    // DeepSeek-V4 NextN/MTP extras: split e/h projections (instead of DSV3 eh_proj)
    // + per-head hyper-connection collapse (the global "output_hc_*" names are taken
    // by the trunk head)
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    // DeepSeek-V4 NextN/MTP extras (split e/h proj + per-head HC collapse); the
    // buft probe op mirrors the HC_ATTN_* pattern (fn -> MUL_MAT, base -> ADD, scale -> MUL)
