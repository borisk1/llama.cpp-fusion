...
public:
    ...
    // Expert routing outputs: one tensor per MoE layer, containing expert indices
    // Populated during graph build, read back after graph compute
    std::vector<ggml_tensor *> expert_routing;
